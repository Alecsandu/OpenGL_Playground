...
public:
	void Init();
	void Clear() const;
	void DrawObjModel(const VertexBuffer&, const VertexBuffer&, const VertexBuffer&, const Texture&) const;  // vector care contine datele legate de varfuri, normalele varfurilor si coordonatelor de texturare pentru un model
